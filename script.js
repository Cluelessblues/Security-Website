...
document.addEventListener("DOMContentLoaded", () => {
  ...
  serviceEnquireBtns.forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      if (serviceSelect) {
        // Find and match selection value
  ...
  // 2. Contact Form Submission Dispatch Simulation
  if (contactForm) {
    contactForm.addEventListener("submit", (e) => {
      ...
      // Create elegant overlay or thank you message
      ...
      document
        ...
        .addEventListener("click", () => {
          ...
          // Reload to fully bind events cleanly
